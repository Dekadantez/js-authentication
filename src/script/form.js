...
export class Form {
  ...
  value = {} //сюди записується значення, яке вводиться в полях на сторінці
  error = {}
  disabled = true
  ...
  setError = (name, error) => {
    ...
    ) //знаходимо спан місце де буде писатися помилка
    ...
    if (span) {
      span.classList.toggle(
        'form__error--active',
        Boolean(error), //тру/фолс - вмикаємо або вмикаємо цей клас
      )
